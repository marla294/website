...
const PostData = props => (
	...
	<p>But, it's worth it.  Won't go into detail, but we had a huge struggle getting pregnant in the first place - it took years - and it feels like a miracle that she's even coming.  So I'd take these small struggles any day of the week over not being able to get pregnant at all.  And this will all be over soon, and will be replaced with taking care of a newborn :)</p>
	...
	<p>This has all been pretty difficult to admit to.  I mean, I'm almost 40, and here I am admitting that I got sucked into watching random people on Instagram parade around and it negatively affected my quality of life.  But, it is what it is.  I hope that admitting that I had a problem with it, and that I quit even though it wasn't completely taking over my life, will empower anyone else who reads this to potentially make a similar decision if they want to.</p>

	<h3>Thoughts on Meta and the Metaverse</h3>

	<p>I am adding this a few days after the original post.  I recently heard about Facebook and their plan to basically create a 3D world.  They created a parent company which now owns Facebook, called "Meta".  I guess they are calling this 3D world the Metaverse - which, sidenote, very much reminds me of Marvel's Multiverse.  Which seems like it should be a warning to all of us!</p>

	<p>I don't think I have to even say it but, this terrifies me.  I definitely don't want Mark Zuckerburg to be in charge of an even more immersive platform that will suck people in even more that it already has.  Something else I have to avoid and explain why I'm avoiding it.  I've already experienced things where, since I'm not on Facebook, I can't like, order from certain restaurants, or view a person's Facebook group that sounds interesting.  I even had to test that linking to a page on a site I work on (seniorcarefinder.com) through Facebook would create the little ad thinger correctly.  Had to sign on for that.  Those are small examples, but what if a company I work at decides to have a meeting in the Metaverse, and I HAVE to be on Facebook to attend?  I don't want this to be out there to potentially tempt me.</p>

...
const PostData = props => (
	<React.Fragment>
		...
		<p>Once you've got the list of words, it's time to start choosing stuff.  I started with the color pallete.  I used the site <a href="https://coolors.co/">https://coolors.co/</a> to choose the initial pallete.  That site is so fun!  I flipped through the colors, took a bunch of screenshots, and then opened them all up and picked the one that seemed to express that list of words the best.  Later on, I expanded on the pallete, and put in 6 more grays and reds that still work with the pallete.</p>
